...
import static com.example.wills.zchsclubs.UtilityVars.BPA;
import static com.example.wills.zchsclubs.UtilityVars.ChineseClub;
import static com.example.wills.zchsclubs.UtilityVars.ChineseHonorSociety;
...
public class DisplayResults extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInsuranceState) {
        ...
        }if(uv.NatureAdventureClub){
            myData.add("Nature and Adventure Club");
        }if(uv.OperationHonduras){
        ...
        if(myData.size() == 0){
            ...
            startResults.setVisibility(View.GONE);
            myTextView.setText("Uh-oh! Looks like you didn't match with any clubs. Retake the quiz and actually answer some questions this time.");
        }
